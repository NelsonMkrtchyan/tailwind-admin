                        ...
                        <div className="col-md-6 mt-4">
                            <div className="card rounded shadow">
                                ...
                                <div className="p-4">
                                    ...
                                    <Link href="#" className="badge badge-link bg-primary me-2 mt-2">Primary</Link>
                                    <Link href="#" className="badge badge-link bg-secondary me-2 mt-2">Secondary</Link>
                                    <Link href="#" className="badge badge-link bg-success me-2 mt-2">Success</Link>
                                    <Link href="#" className="badge badge-link bg-danger me-2 mt-2">Danger</Link>
                                    <Link href="#" className="badge badge-link bg-warning me-2 mt-2">Warning</Link>
                                    <Link href="#" className="badge badge-link bg-info me-2 mt-2">Info</Link>
                                    <Link href="#" className="badge badge-link bg-light text-dark me-2 mt-2">Light</Link>
                                    <Link href="#" className="badge badge-link bg-dark me-2 mt-2">Dark</Link>
                                </div>
                            </div>
                        </div>
                    </div>
