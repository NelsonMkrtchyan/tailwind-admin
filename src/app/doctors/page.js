                ...
                <div className="layout-specing">
                    <div className="row">
                        ...
                        <div className="col-xl-3 col-md-6 mt-4 mt-md-0 text-md-end">
                            <Link href="/add-doctor" className="btn btn-primary">Add New Doctor</Link>
                        </div>
                    </div>
                                    ...
                                    <div className="card team border-0 rounded shadow overflow-hidden">
                                        <div className="team-img position-relative">
                                            ...
                                            <ul className="list-unstyled team-social mb-0">
                                                ...
                                                <li className="mt-2"><Link href="#" className="btn btn-icon btn-pills btn-soft-primary"><FiInstagram className="icons"/></Link></li>
                                        ...
                                        <div className="card-body content text-center">
                                            <Link href={`/dr-profile/${item.id}`} className="title text-dark h5 d-block mb-0">{item.name}</Link>
