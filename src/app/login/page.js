                                ...
                                <form className="login-form mt-4">
                                    <div className="row">
                                        ...
                                        <div className="col-6 mt-3">
                                            <div className="d-grid">
                                                <Link href="#" className="btn btn-soft-primary"><AiFillFacebook /> Facebook</Link>
                                            </div>
                                        </div>
                                        
                                        <div className="col-6 mt-3">
                                            <div className="d-grid">
                                                <Link href="#" className="btn btn-soft-primary"><SlSocialGoogle /> Google</Link>
                                            </div>
                                        </div>

                                        <div className="col-12 text-center">
                                            <p className="mb-0 mt-3"><small className="text-dark me-2">Don't have an account ?</small> <Link href="/signup" className="text-dark fw-bold">Sign Up</Link></p>
                                        </div>
                                    </div>
                                </form>
                            </div>
