...
export default function PersonChat(){
    ...
    return(
        <div className="card chat chat-person border-0 shadow rounded">
                ...
                <ul className="list-unstyled mb-0">
                    <li className="dropdown dropdown-primary list-inline-item">
                        ...
                        <div className={`${show ? 'show' : ''} dropdown-menu dd-menu dropdown-menu-end shadow border-0 mt-3 py-3`} style={{right:'0'}}>
                            <Link className="dropdown-item text-dark" href="#"><span className="mb-0 d-inline-block me-1"><LuUser2 className="align-middle h6 mb-0"/></span> Profile</Link>
                            <Link className="dropdown-item text-dark my-1" href="#"><span className="mb-0 d-inline-block me-1"><FiSettings className="align-middle h6 mb-0"/></span> Profile Settings</Link>
            ...
            <SimpleBar style={{maxHeight:'295px',backgroundImage:`url('/images/bg/bg-chat.png')`, backgroundPosition:'center'}}>
            ...
            <div className="p-2 rounded-bottom shadow">
                <div className="row">
                    ...
                    <div className="col-auto">
                        <Link href="#" className="btn btn-icon btn-primary"><BsSend /></Link>
