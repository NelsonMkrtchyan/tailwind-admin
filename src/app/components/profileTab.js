...
import {FiArrowRight, RiMapPinLine, RiTimeLine, RiMoneyDollarCircleLine, FiFacebook, FiLinkedin, FiGithub, FiTwitter, FiHeart, RiTimeFill, FiPhone, FiMail} from '../assets/icons/vander'
import {doctorData, experienceData, clientReview, companyLogo, drTimetable} from '../data/data'
                                        ...
                                        <div className="p-4">
                                            <div className="row align-items-center">
                                                <div className="col-lg-2 col-md-4">
                                                    <Image src='/images/client/01.jpg' width={110} height={110} className="avatar avatar-md-md rounded-pill shadow mx-auto d-block" alt=""/>
                                                </div>
