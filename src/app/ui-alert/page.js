...
import { FiInfo, MdOutlineCheckCircleOutline, BsExclamationTriangle, FiAlertOctagon, FiChevronRight } from '../assets/icons/vander'
                        ...
                        <div className="col-lg-6 mt-4">
                            <div className="card rounded shadow">
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="alert alert-primary" role="alert">A simple primary alert with <Link href="#" className="alert-link">an link</Link>.</div>
                                    <div className="alert alert-secondary" role="alert">A simple secondary alert with <Link href="#" className="alert-link">an link</Link>.</div>
                                    <div className="alert alert-success" role="alert">A simple success alert with <Link href="#" className="alert-link">an link</Link>.</div>
                                    <div className="alert alert-danger" role="alert">A simple danger alert with <Link href="#" className="alert-link">an link</Link>.</div>
                                    <div className="alert alert-warning" role="alert">A simple warning alert with <Link href="#" className="alert-link">an link</Link>.</div>
                                    <div className="alert alert-info" role="alert">A simple info alert with <Link href="#" className="alert-link">an link</Link>.</div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="d-block">
                                        <div className="alert alert-primary alert-pills" role="alert">
                                            ...
                                            <span className="content"> A Modern primary alert—check it out! <FiChevronRight/></span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="d-block">
                                        <div className="alert alert-danger alert-pills mb-0" role="alert">
                                            ...
                                            <span className="content"> A Modern danger alert—check it out! <FiChevronRight/> </span> 
                                        </div>
                                    </div>
                                </div>
                            </div>
