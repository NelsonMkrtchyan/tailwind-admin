                            ...
                            <div className="card rounded shadow">
                                ...
                                <div className="p-4">
                                    <h6 className="text-muted mb-2 pb-2">Ex. <br/> 
                                        <pre><code className="text-danger">
                                            &lt;OverlayTrigger trigger="click" key='top' placement='top' overlay=&#123; <br/>
                                                ...
                                                &nbsp;&lt;/Popover&gt;&#125;<br/>
                                                &gt;<br/>
                                                &nbsp;&nbsp;&nbsp;&lt;Link href="#" className="btn btn-primary me-2 mt-2 text-capitalize"&gt;top&lt;/Link&gt;<br/>
                                            &lt;/OverlayTrigger&gt;<br/>
                                            </code>
                                        </pre>
                                    </h6>
                                    <div className="d-inline position-relative">
                                        ...
                                        >
                                            <Link href="#" scroll={false} className="btn btn-primary me-2 mt-2 text-capitalize">top</Link>
                                        </OverlayTrigger>
                                    </div>
                                        ...
                                        >
                                            <Link href="#" scroll={false} className="btn btn-primary me-2 mt-2 text-capitalize">right</Link>
                                        </OverlayTrigger>
                                        ...
                                        >
                                            <Link href="#" scroll={false} className="btn btn-primary me-2 mt-2 text-capitalize">bottom</Link>
                                        </OverlayTrigger>
                                        ...
                                        >
                                            <Link href="#" scroll={false} className="btn btn-primary me-2 mt-2 text-capitalize">left</Link>
                                        </OverlayTrigger>
                                </div>
                            </div>
                        </div>
