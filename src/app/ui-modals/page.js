                    ...
                    <div className="row">
                        <div className="col-12 mt-4">
                            <div className="card rounded shadow">
                                ...
                                <div className="p-4">
                                    <Link href="#" scroll={false} onClick={() =>setShow(true)} className="btn btn-primary m-1"> Click Here</Link>
                                    <Link href="#" scroll={false} onClick={() =>setShow2(true)} className="btn btn-primary m-1"> Login Popup</Link>
                                    <Link href="#" scroll={false} onClick={() =>setShow3(true)} className="btn btn-primary m-1">Subscribe Popup</Link>
                                    <Link href="#" scroll={false} onClick={() =>setShow4(true)} className="btn btn-primary m-1">Wishlist Popup</Link>
                                    <Link href="#" scroll={false} onClick={() =>setShow5(true)} className="btn btn-primary m-1">Empty Cart Popup</Link>
                                </div>
                                                ...
                                                <div className="container-fluid px-0">
                                                    <div className="row align-items-center g-0">
                                                        <div className="col-lg-6 col-md-5">
                                                            <Image src='/images/ab02.jpg' width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} className="img-fluid" alt=""/>
                                                        </div>
                                ...
                                <div className="modal-dialog  modal-lg modal-dialog-centered">
                                    <div className="modal-content rounded shadow border-0">
                                        <Modal show={show3} onHide={() =>setShow3(false)} centered size='lg' >
                                            <Modal.Body className='p-0'>
                                                <div className="modal-body p-0" style={{backgroundImage:`url('/images/subscribe.png')`,backgroundRepeat:'no-repeat'}}>
                                    ...
                                    <Modal show={show5} onHide={() =>setShow5(false)} centered>
                                        <Modal.Body className='p-4'>
                                            <div className="modal-body">
                                                <div className="text-center">
                                                    <Image src='/images/pharmacy/cart.png' width={110} height={110} className="avatar avatar-medium rounded-circle shadow" alt=""/>
                                                    <div className="mt-4">
