                    ...
                    <div className="row">
                        <div className="col-12 mt-4">
                            <div className="card rounded shadow">
                                ...
                                <div className="p-4">
                                    <h6>React Icons</h6>
                                    <p className="text-muted">Include popular icons in your React projects easily with react-icons, which utilizes ES6 imports that allows you to include only the icons that your project is using. <Link href="https://react-icons.github.io/react-icons/" target="_blank"><code className="text-primary">https://react-icons.github.io/react-icons/</code></Link></p>
                                    ...
                                    <p className="text-muted">There are 4400+ Material Design icons and you can get all icons info from here: <Link href="https://materialdesignicons.com/" target="_blank"><code className="text-primary">https://materialdesignicons.com/</code></Link></p>
