...
import { blogcomment ,recentBlog} from "../data/data";
            ...
            <div className="container-fluid">
                <div className="layout-specing">
                    <div className="d-md-flex justify-content-between">
                        <div>
                            <h5 className="mb-0">Lockdowns lead to fewer people seeking medical care</h5>

                            <ul className="list-unstyled mt-2 mb-0">
                                <li className="list-inline-item user text-muted me-2"><i className="mdi mdi-account"></i> Calvin Carlo</li>
                                <li className="list-inline-item date text-muted"><i className="mdi mdi-calendar-check"></i> 19th June, 2023</li>
                            </ul>
                        </div>
                    ...
                    <div className="row">
                        <div className="col-lg-8 col-lg-7 mt-4">
                            <div className="card rounded shadow border-0 overflow-hidden">
                                <Image src='/images/blog/single.jpg' width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} className="img-fluid" alt=""/>
